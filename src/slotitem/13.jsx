...
const Icon = React.memo(props => (
  <svg width="1em" height="1em" viewBox="0 0 640 640" {...props}>
    <defs>
      ...
      <linearGradient x1="85.495%" y1="0%" x2="43.175%" y2="42.663%" id="prefix__c">
        <stop stopColor="#933E3E" offset="0%" />
        <stop stopColor="#D15B5B" offset="100%" />
      </linearGradient>
      <linearGradient x1="100%" y1="19.61%" x2="59.865%" y2="60.392%" id="prefix__d">
        <stop stopColor="#913D3D" offset="0%" />
        <stop stopColor="#D15B5B" offset="100%" />
      </linearGradient>
      <radialGradient cx="100%" cy="0%" fx="100%" fy="0%" r="140.448%" id="prefix__e">
        <stop stopColor="#913D3D" offset="0%" />
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <path fill="url(#prefix__c)" d="M320 200L200 320v20l140-140z" />
      <path fill="url(#prefix__d)" d="M120 199.995L200 120h40L120 239.995z" />
      <path fill="url(#prefix__e)" d="M80 80h100v20l-80 80H80z" />
    </g>
  </svg>
))
export default Icon
