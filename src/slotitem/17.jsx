...
const Icon = React.memo(props => (
  <svg width="1em" height="1em" viewBox="0 0 640 640" {...props}>
    <defs>
      ...
      <linearGradient x1="75.125%" y1="0%" x2="75.125%" y2="74.6%" id="prefix__c">
        <stop stopColor="#72B8C5" offset="0%" />
        <stop stopColor="#7ECCD8" offset="100%" />
      </linearGradient>
    </defs>
    <g fill="none" fillRule="evenodd">
      <path fill="#7ECCD8" d="M340 500h40v40h-40zM420 420h40v40h-40zM500 340h40v40h-40z" />
      <use fill="#000" filter="url(#prefix__a)" xlinkHref="#prefix__b" />
      <use fill="#7ECCD8" xlinkHref="#prefix__b" />
      <path fill="url(#prefix__c)" d="M260 280l60 60 180-180-60-60z" />
    </g>
  </svg>
))
export default Icon
