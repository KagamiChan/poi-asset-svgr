...
const Icon = React.memo(props => (
  <svg width="1em" height="1em" viewBox="0 0 640 640" {...props}>
    <defs>
      ...
      <linearGradient x1="63.911%" y1="33.306%" x2="0%" y2="0%" id="prefix__c">
        <stop stopColor="#5785A9" offset="0%" />
        <stop stopColor="#3A5A74" offset="100%" />
      </linearGradient>
      <linearGradient x1="31.93%" y1="22.957%" x2="29.698%" y2="39.586%" id="prefix__d">
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <use fill="#5785A9" xlinkHref="#prefix__b" />
      <path fill="url(#prefix__c)" d="M180 210v80l180 140V330z" />
      <path fill="url(#prefix__d)" d="M360 150l140 80 80 20-100-60z" />
    </g>
  </svg>
))
export default Icon
