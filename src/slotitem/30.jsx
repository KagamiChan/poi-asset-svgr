...
const Icon = React.memo(props => (
  <svg width="1em" height="1em" viewBox="0 0 640 640" {...props}>
    <defs>
      ...
      <path id="prefix__c" d="M120 420l80-40h180l140 40-80 40H260z" />
      <filter
        x="-3.7%"
        y="-18.8%"
        width="115%"
      ...
      <path id="prefix__e" d="M440 260l80-40v200l-80 40z" />
      <filter
        x="-18.8%"
        y="-6.2%"
        width="175%"
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <g filter="url(#prefix__a)" transform="matrix(-1 0 0 1 600 260)">
