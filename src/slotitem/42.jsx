...
const Icon = React.memo(props => (
  <svg width="1em" height="1em" viewBox="0 0 640 640" {...props}>
    <defs>
      ...
      <linearGradient x1="63.089%" y1="0%" x2="28.387%" y2="100%" id="prefix__b">
        <stop stopColor="#9EBAE0" offset="0%" />
        <stop stopColor="#8299B7" offset="100%" />
      </linearGradient>
    </defs>
    <g filter="url(#prefix__a)" transform="translate(100 90)" fill="none" fillRule="evenodd">
      <path
      ...
      <path fill="url(#prefix__b)" d="M240 300v20H0v40l120 100h200l120.193-120-.193-40z" />
    </g>
  </svg>
))
export default Icon
