...
const Icon = React.memo(props => (
  <svg width="1em" height="1em" viewBox="0 0 640 640" {...props}>
    <defs>
      <path id="prefix__b" d="M80 360v40l160 160h40l280-280v-40L400 80h-40z" />
      <filter
        x="-3.1%"
        y="-3.1%"
        width="112.5%"
      ...
      <linearGradient x1="100%" y1="80.552%" x2="0%" y2="0%" id="prefix__c">
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <use fill="#997EAE" xlinkHref="#prefix__b" />
